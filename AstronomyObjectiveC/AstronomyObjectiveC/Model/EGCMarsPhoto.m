...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (self) {
        ...
        _camera = [[EGCCamera alloc] initWithDictionary:dictionary[@"camera"]];
...
{
    if (!object || ![object isKindOfClass:[EGCMarsPhoto class]]) { return NO; }
    EGCMarsPhoto *photo = object;
